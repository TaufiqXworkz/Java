...
public static String storage(int sal,String name){
	return "salary is"+sal+" Name is:"+name;
}
public static String storage(String email,int sal,String name){

	return "Enter Email id :"+email+"Storage is:"+sal+" Name is:"+name;
}
